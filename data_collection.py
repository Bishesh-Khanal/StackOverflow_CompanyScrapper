...
companies_dictionary = {'Name': [], 'Location': [], 'Type': [], 'Website': [], 'Specialities': [], 'Size': [], 'Founded': [], 'Status': [], 'Followers on Stack Overflow':[], 'Link': []}

page_start = 1
page_end = 12

companies_dataFrame = scrapper(companies_dictionary, userAgents, page_start, page_end)
